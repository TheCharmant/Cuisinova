...
# 🍳 CUISINOVA - AI-Powered Recipe App
...
**CUISINOVA** is an **AI-powered web application** that uses **GPT-4** to generate unique recipes based on selected ingredients and dietary preferences, **DALL·E** to create custom recipe images, and **TTS** to narrate recipes. It's designed to make cooking easy, creative, and accessible for everyone.

🎥 **App Demo**

![Cuisinova: AI Recipe Generator Demo](./public/demo.gif)

🌐 **[Live Demo →](https://cuisinova.cloud/)**
...
```bash
git clone https://github.com/TheCharmant/Cuisinova.git
cd cuisinova
```
